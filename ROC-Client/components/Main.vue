<template>
  <div class="mx-auto align-middle">
    <div class="flex flex-col">
      <div class="text-right"><input maxlength="25" class="border border-purple-600 rounded" placeholder="Panel Here" v-model="panel">
    ...
    <div class="grid grid-cols-4 divide-x divide-gray-500 flex">
      <div class="flex flex-col flex-grow col-span-3 mx-2 divide-y divide-gray-500">
        <Sim v-for="(simData, simID) in gameData" :key="simID" :simData="simData" :socket="socket" :username="username"
             :panel="panel" @movedSim="movedSim" @leaveCall="leaveCall" class="mb-10"/>
      </div>
      <div class="flex-grow">
        <div class="py-5 mx-2">
